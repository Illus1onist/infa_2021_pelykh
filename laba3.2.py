...
'''
Функция рисует солнышко на экране.
- время суток.
'''
def draw_sun( ):
...
'''
Функция рисует дальние на экране.
- время суток.
'''
def draw_mountains( ):
...
'''
Функция рисует передние горы на экране.
- время суток.
'''
def drawground( ):
